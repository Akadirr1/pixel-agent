...
export const EXPECTED_PACKAGE_NAME = '@akadirr1/pixel-agent';
export const EXPECTED_REPOSITORY_URL = 'git+https://github.com/Akadirr1/pixel-agent.git';
...
// dist/cli.js (see esbuild.js), so the published `pixel-agent` bin resolves them from
